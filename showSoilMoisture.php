     ...
     var myapp = angular.module("app", []);
        myapp.controller("mycontroller", function($scope, $http) {
            ...
            $scope.doFetchJson= function() {
                ...
                $http.get("fetchSoilData.php").then(ok, notok);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-8 d-block d-sm-none float-right" style="margin-top:7px">
                        <center>
                            <h4>IOT based smart Agriculture  Monitoring</h4>
                        </center>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-8 d-sm-block d-lg-none d-none float-right" style="margin-top:7px">
                        <center>
                            <h1>IOT based smart Agriculture  Monitoring</h1>
                        </center>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 d-sm-none d-none d-lg-block">
                <center>
                    <div id="infolines">Soil Moisture Data</div>
                </center>
            </div>
        </div>
    </div>
